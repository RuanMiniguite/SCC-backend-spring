...
public class _DBService {
	...
	public void instantiateTestDatabase() throws ParseException, IOException {
        ...
        Cliente cliente1 = new Cliente(null, "Ruan Miniguite", "111.111.111-11", "Ruanminiguite@gmail.com", "(28)99918-3529", "Espirito Santo", "29295-000", "Vargem alta", "Pombal de Cima", Pessoa.FISICA);
        Cliente cliente2 = new Cliente(null, "Pedro Miniguite", "222.222.222-22", "Pedrominiguite@gmail.com", "(28)99912-1292", "Espirito Santo", "29295-000", "Vargem alta", "São josé de fruteiras", Pessoa.JURIDICA);
        
        
        Funcionario funcionario1 = new Funcionario (null, "Alberto Ricado", "017.268.037-98", "(27)99865-9856)", sdf.parse("2000-04-01"), "Espirito Santo", "95689-000", "Pedra Azul", "Águas Vermelhas", "AlbertoR", "123456", "Vendedor", 2500.66,  Admin.GERENTE);
	    Funcionario funcionario2 = new Funcionario (null, "Marcos Bravim", "968.569.787-45", "(27)99999-9786)", sdf.parse("1998-10-12"), "Espirito Santo", "29500-000", "Cachoeiro de Itapemirim", "Agostinho Simonato", "MarcosB", "789123", "Vendedor", 1856.44,  Admin.FUNCIONARIO);
	    Funcionario funcionario3 = new Funcionario (null, "Mariana Ribeiro", "896.146.195-78", "(28)97896-9789)", sdf.parse("1989-07-07"), "Espirito Santo", "29300-000", " Cachoeiro de Itapemirim", "Santo Antonio", "MarianaR", "456321", "Gerente", 4500.50, Admin.FUNCIONARIO);
        ...
        RealizaRecall realizaRecall= new RealizaRecall(null, sdf.parse("2022-05-21"),null, moto1, recall1);
        RealizaRecall realizaRecal2= new RealizaRecall(null, sdf.parse("2022-05-21"),null, moto2, recall1);
        ...
        itemRevisao ItemRevisao1 = new itemRevisao(null, "Bateria", 307.02, 1);
        itemRevisao ItemRevisao2 = new itemRevisao(null, "Óleo Lubrificante", 30.00, 1);
