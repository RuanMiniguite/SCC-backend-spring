...
public class _DBService {
	...
	public void instantiateTestDatabase() throws ParseException, IOException {
        ...
        Cliente cliente1 = new Cliente(null, "Ruan Miniguite", "111.111.111-11", "Ruanminiguite@gmail.com", "(28)99918-9999", "ES", "29295-000", "Vargem alta", "Pombal de Cima", 0);
        Cliente cliente2 = new Cliente(null, "Pedro Miniguite", "222.222.222-22", "Pedrominiguite@gmail.com", "(28)99912-1292", "ES", "29295-000", "Vargem alta", "São josé de fruteiras", 1);
        Cliente cliente3 = new Cliente(null, "Alberto Ricado", "017.268.037-98", "AlbertoRicado@gmail.com", "(27)99865-9856", "ES", "95689-000", "Pedra Azul", "Águas Vermelhas", 0);
        
        
        Funcionario funcionario1 = new Funcionario (null, "Alberto Ricado", "017.268.037-98", "(27)99865-9856", sdf.parse("2000-04-01"), "ES", "95689-000", "Pedra Azul", "Águas Vermelhas", "AlbertoR", "123456", "Vendedor", 2500.66, 1, sdf.parse("2015-01-01"));
	    Funcionario funcionario2 = new Funcionario (null, "Marcos Bravim", "968.569.787-45", "(27)99999-9786", sdf.parse("1998-10-12"), "ES", "29500-000", "Cachoeiro de Itapemirim", "Agostinho Simonato", "MarcosB", "789123", "Vendedor", 1856.44, 0, sdf.parse("2018-01-01"));
	    Funcionario funcionario3 = new Funcionario (null, "Mariana Ribeiro", "896.146.195-78", "(28)97896-9789", sdf.parse("1989-07-07"), "ES", "29300-000", " Cachoeiro de Itapemirim", "Santo Antonio", "MarianaR", "456321", "Gerente", 4500.50, 0, sdf.parse("2020-01-01"));
